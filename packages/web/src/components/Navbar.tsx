      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        {user ? (
          <div className="flex items-center space-x-4">
            <Link
              href="/kits/new"
              className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium rounded-lg text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow-sm shadow-indigo-600/30 transition-all duration-150"
            >
            ...
            <div className="hidden sm:flex items-center space-x-2 text-sm text-slate-400 border-l border-slate-800 pl-4">
